export default function AIRecommendationCard() {
  return (
    <section className="col-span-5 rounded-xl border border-slate-800 bg-[#071323] p-6">
      ...
      <button className="mt-6 rounded-lg bg-purple-700 px-8 py-3 text-sm text-white">
